Hey, This is a small python project implementing polynomials using degrees of X > 0. It aims to showcase the ability of computers to approximate roots, derivatives and point values of each
function.
